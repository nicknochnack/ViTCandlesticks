...
def generate_data(stick:int) -> None: 
    ...
    # Morning star
        ...
        # Stick 2 
        open_price = min(open_price, close_price, high_price, low_price) * np.random.normal(.95, 0.00005)
        close_price = close_price * np.random.normal(.95, 0.00005) 
        high_price = round(max(np.random.randint(100,high=103)*open_price/100, np.random.randint(100,high=103)*close_price/100),2)
        low_price = round(min(np.random.randint(97,high=100)*open_price/100, np.random.randint(97,high=100)*close_price/100), 2)
        prices.append([open_price, high_price,low_price, close_price])

        # Stick 3
        open_price = np.random.normal(1.00, 0.00025)*close_price
    ...
    # Evening star
        ...
        # Stick 2 
        open_price = max(open_price, close_price, high_price, low_price) * np.random.normal(1.05, 0.00005)
        close_price = close_price * np.random.normal(1.00, 0.00005) 
        high_price = round(max(np.random.randint(100,high=103)*open_price/100, np.random.randint(100,high=103)*close_price/100),2)
        low_price = round(min(np.random.randint(97,high=100)*open_price/100, np.random.randint(97,high=100)*close_price/100), 2)
        prices.append([open_price, high_price,low_price, close_price])

        # Stick 3
        open_price = np.random.normal(1.000, 0.00025)*close_price
        close_price = np.random.normal(.95, 0.00005)*open_price
        high_price = round(max(np.random.randint(100,high=103)*open_price/100, np.random.randint(100,high=103)*close_price/100),2)
        low_price = round(min(np.random.randint(97,high=100)*open_price/100, np.random.randint(97,high=100)*close_price/100), 2)
        prices.append([open_price, high_price,low_price, close_price])
    ...
    with open('zz_generated/labels.csv', 'a') as f:
        writer = csv.writer(f)
        writer.writerow([image_name,stick])
    ...
    fig.write_image(f'zz_generated/{image_name}')
